...
extern "C" {
    ...
    typedef Handle		(*FBM_INIT_EX)(u32 max_frame_num, u32 min_frame_num, u32 size_y[], u32 size_u[], u32 size_v[],
                                       u32 size_alpha[], _3d_mode_e out_3d_mode, pixel_format_e format, void* parent);
    ...
    extern IVEControl_t IVE __attribute__((weak));
    extern IOS_t        IOS __attribute__((weak));
    extern IFBM_t       IFBM __attribute__((weak));
    extern IVBV_t       IVBV __attribute__((weak));
